 ...
 * @brief TDD layer implementation for YX1903B RGB LED pixel controller
 *
 * This source file implements the TDD layer driver for YX1903B RGB LED pixel controllers.
 ...
 * for driving YX1903B LED strips.
 *
...
******************************macro define****************************
*********************************************************************/
#define DRV_SPI_SPEED 6500000 /* SPI baud rate */
 ...
 */
OPERATE_RET tdd_yx1903b_driver_open(DRIVER_HANDLE_T *handle, unsigned short pixel_num)
{
 ...
 * @return: success -> 0  fail -> else
 */
OPERATE_RET tdd_yx1903b_driver_send_data(DRIVER_HANDLE_T handle, unsigned short *data_buf, unsigned int buf_len)
{
 ...
 * @return: success -> 0  fail -> else
 */
OPERATE_RET tdd_yx1903b_driver_close(DRIVER_HANDLE_T *handle)
{
    OPERATE_RET ret = OPRT_OK;
    DRV_PIXEL_TX_CTRL_T *tx_ctrl = NULL;
