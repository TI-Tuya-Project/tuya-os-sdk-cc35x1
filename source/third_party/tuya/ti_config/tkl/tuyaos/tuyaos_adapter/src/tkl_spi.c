...
OPERATE_RET tkl_spi_init(TUYA_SPI_NUM_E port, const TUYA_SPI_BASE_CFG_T *cfg)
{
    ...
    // default to blocking transfers for now. TODO: might change later.
...
OPERATE_RET tkl_spi_deinit(TUYA_SPI_NUM_E port)
{
    ...
    // Cancel any in-progress queued/callback transfers. Safe to call even if no transfer is active.
