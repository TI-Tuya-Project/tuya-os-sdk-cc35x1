...
#define TKL_HW_MAX_SPI_PORTS    2 // Added SPI
...
typedef struct {
    ...
    // SPI Mapping: Tuya Port -> TI Driver Index
    int16_t spi_map[TKL_HW_MAX_SPI_PORTS];
...
int16_t tkl_hw_get_spi_index(uint8_t port); // Added
