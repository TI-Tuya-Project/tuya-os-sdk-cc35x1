...
#include <dpl/ClockPWFF3_freertos.c>
#include <dpl/HwiPWFF3_freertos.c>
#include <dpl/PowerWFF3_freertos.c>
#include <dpl/TimestampPWFF3_freertos.c>
#include <startup/startup_cc35xx_ticlang.c>

/* C files contributed by /freertos/exception */
#include <exception/ExceptionArmV8M.c>
